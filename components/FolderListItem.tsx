  ...
  return (
    <li className="folder-row relative">
      <Link
        ...
        className="folder-item flex w-full items-center justify-between rounded-lg px-3 py-2 pr-16 text-left text-sm text-[var(--text)]"
      >
      ...
      <div className="folder-actions absolute right-1.5 top-1/2 flex -translate-y-1/2 items-center gap-0.5">
        <button
          ...
          className="folder-action-btn rounded-md p-1.5 text-[var(--text-sub)]"
        >
          <svg
